...
class _EditChildState extends State<EditChild> {
  ...
  @override
  void initState() {
    _fNameController.text = widget._kid.name;
    _lNameController.text = widget._kid.name;
    _schoolNameController.text = widget._kid.schoolName;
